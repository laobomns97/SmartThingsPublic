metadata {
	definition (name: "Lumi 1 Button Switch", namespace: "Thonv", author: "Thonv") {
		capability "Actuator"
//		capability "Configuration"
	...
	tiles {
		...
		main (["switch1"])
		details(["switch1", "onAll", "offAll","ConfigureButton","refresh" ])
	}
}
...
def on1() {
    ...
    "st cmd 0x${device.deviceNetworkId} 1 0x0006 1 {}" + "delay 1000"
}

def off1() {
	log.debug "Executing 'off1' 0x${device.deviceNetworkId} endpoint 1"
	"st cmd 0x${device.deviceNetworkId} 1 0x0006 0 {}" + "delay 1000"
}

def on5() {
	log.debug "Executing 'on5' 0x${device.deviceNetworkId} endpoint 15"
    "st cmd 0x${device.deviceNetworkId} 15 0x0006 1 {}"+ "delay 1000"
}

def off5() {
	log.debug "Executing 'off5' 0x${device.deviceNetworkId} endpoint 15"
	"st cmd 0x${device.deviceNetworkId} 15 0x0006 0 {}" + "delay 1000"
}

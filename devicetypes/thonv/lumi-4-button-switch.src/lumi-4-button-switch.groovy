metadata {
	definition (name: "Lumi 4 Button Switch", namespace: "Thonv", author: "Thonv") {
		capability "Actuator"
	...
	tiles {
		...
		details(["switch1", "switch2", "onAll", "switch3", "switch4", "offAll","ConfigureButton",  "switchAll","refresh" ])
	}
}
